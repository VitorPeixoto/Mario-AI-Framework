package marioai.levelGenerators.notch;

import marioai.engine.core.MarioLevelGenerator;
import marioai.engine.core.MarioLevelModel;
...
public class LevelGenerator implements MarioLevelGenerator {
    ...
    public String getGeneratedLevel(MarioLevelModel model, MarioTimer timer) {
        return getGeneratedLevel(model, timer, 0, 0, 1, 1, 1);
    }

    public String getGeneratedLevel(MarioLevelModel model, MarioTimer timer, int straightMargin, int hillMargin, int tubeMultiplier, int jumpMultiplier, int cannonsMultiplier) {
        model.clearMap();

        odds[ODDS_STRAIGHT] = 20 + straightMargin;
        odds[ODDS_HILL_STRAIGHT] = 10 + hillMargin;
        odds[ODDS_TUBES] = 2 + (tubeMultiplier * difficulty);
        odds[ODDS_JUMP] = 2 * (jumpMultiplier * difficulty);
        odds[ODDS_CANNONS] = -10 + 5 * (cannonsMultiplier * difficulty);

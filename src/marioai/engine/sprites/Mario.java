package marioai.engine.sprites;

import java.awt.*;
import java.util.ArrayList;
import java.util.Date;

import marioai.engine.core.MarioSprite;
import marioai.engine.graphics.MarioImage;
import marioai.engine.helper.Assets;
import marioai.engine.helper.EventType;
import marioai.engine.helper.MarioActions;
import marioai.engine.helper.SpriteType;
import marioai.engine.helper.TileFeature;
...
public class Mario extends MarioSprite {
    ...
    public void render(Graphics og) {
        ...
        points.add(new Point((int) (this.x - this.world.cameraX), (int) (this.y - this.world.cameraY)));
        og.setColor(Color.red);
        Point prevPoint = points.get(0);
        for(Point point : points) {
            //og.fillOval((int) point.getX(), (int) point.getY()-10, 5, 5);
            og.drawLine((int) prevPoint.getX(), (int) prevPoint.getY()-1, (int) point.getX(), (int) point.getY()-1);
            og.drawLine((int) prevPoint.getX(), (int) prevPoint.getY(), (int) point.getX(), (int) point.getY());
            og.drawLine((int) prevPoint.getX(), (int) prevPoint.getY()+1, (int) point.getX(), (int) point.getY()+1);
            prevPoint = point;
        }
    }

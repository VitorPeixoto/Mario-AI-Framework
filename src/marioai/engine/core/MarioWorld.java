package marioai.engine.core;

import java.awt.Graphics;
import java.awt.GraphicsConfiguration;
import java.util.ArrayList;

import marioai.engine.effects.*;
import marioai.engine.graphics.MarioBackground;
import marioai.engine.helper.EventType;
import marioai.engine.helper.GameStatus;
import marioai.engine.helper.SpriteType;
import marioai.engine.helper.TileFeature;
import marioai.engine.sprites.*;
...
public class MarioWorld {
    ...
    public void update(boolean[] actions) {
        ...
        this.currentTick += 1;
        this.cameraX = this.mario.x - MarioGame.width;
